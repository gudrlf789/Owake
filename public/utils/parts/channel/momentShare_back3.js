...
export const momentShareFunc = () => {
    ...
    function socketSubmitAddressEmit(url) {
        momentSocket.emit("submit_address", url, {
            peerID: options.uid,
    ...
    function receiveMouseEventFunc() {
        ...
        momentSocket.on("receive_mousedown", (mouseEvent) => {
            ...
            console.log(":::::::::::receiveURL:::::::::::::", receiveURL);
            defaultMomentShare(receiveURL);
            createMomentTabFunc(receiveURL);
        });
    ...
    function naverTVPlayer(url) {
        ...
        if (url.includes("/v/")) {
            urlEndPoint = url.indexOf("/v/");
            console.log(urlEndPoint);
            channel = url.substring(urlEndPoint + 3, url.indexOf("/list/"));
            originalURL = url.substring(0, urlEndPoint);
